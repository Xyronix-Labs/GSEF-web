...
} from "@/app/lib/schemas/application-schema";
...
export default function ApplyPage() {
	...
	// Add this state for tracking uploaded files
	...
	const handleFileChange = (
		...
		if (e.target.files && e.target.files[0]) {
			...
			// Validate file size
			const maxSize =
				documentType === "photo" ? 1 * 1024 * 1024 : 2 * 1024 * 1024; // 1MB for photo, 2MB for others
	...
	const onSubmit = async (data: ApplicationFormData) => {
		...
		try {
			...
			Object.entries(uploadedFiles).forEach(([documentType, file]) => {
				...
				console.log(`Added file: ${documentType}`, file.name);
			});
			...
			if (result.success) {
				...
				try {
					...
					console.error("Error storing application ID:", e);
				}
			} else {
			...
			return (
				<div className='text-center py-12'>
					...
					<p className='text-xl text-gray-300 mb-8 max-w-2xl mx-auto'>
						Thank you for submitting your application for the Indo-African
						Scholarship program. Your application has been received and is under
						review.
					</p>
					<p className='text-lg text-gray-300 mb-8'>
						Your Application ID:{" "}
						<span className='font-bold text-brand-orange'>{applicationId}</span>
					</p>
					<p className='text-lg text-gray-300 mb-8'>
						Please save this ID for future reference. You can use it to check
						...
						<div className='space-y-6'>
							...
							<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
								<div>
									<label
										...
										className='block text-white font-medium mb-2'
									>
										Annual Income of Father (from all sources){" "}
										<span className='text-red-500'>*</span>
									</label>
									<div className='flex gap-2'>
										<Input
											...
											className={`bg-gray-700/50 border-gray-600 text-white flex-1 ${
												errors.fatherIncome ? "border-red-500" : ""
											}`}
								...
								<div>
									...
									<div className='flex gap-2'>
										<Input
											...
											className={`bg-gray-700/50 border-gray-600 text-white flex-1 ${
												errors.motherIncome ? "border-red-500" : ""
											}`}
							...
							<div className='bg-gray-800/30 p-6 rounded-lg border border-gray-700'>
								...
								{siblingFields.map((field, index) => (
									<div
										key={field.id}
										className='bg-gray-700/30 p-4 rounded-lg mb-4'
									>
									...
									<Controller
										...
										render={({ field }) => (
											<RadioGroup
												...
												className='flex gap-6'
												aria-invalid={
													errors.currentlyEnrolled ? "true" : "false"
												}
											>
												<div className='flex items-center space-x-2'>
													<RadioGroupItem
							...
							<div className='bg-gray-800/30 p-6 rounded-lg border border-gray-700 mb-6'>
								...
								<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
									<div>
										...
										<Input
											...
											{...register("tenthScore")}
											className={`bg-gray-700/50 border-gray-600 text-white ${
												errors.tenthScore ? "border-red-500" : ""
											}`}
											aria-invalid={errors.tenthScore ? "true" : "false"}
										/>
										{errors.tenthScore && (
											<p className='text-red-500 text-sm mt-1'>
												{errors.tenthScore.message}
											</p>
										)}
									</div>
									...
									<div>
										...
										<Input
											...
											{...register("tenthYear")}
											className={`bg-gray-700/50 border-gray-600 text-white ${
												errors.tenthYear ? "border-red-500" : ""
											}`}
								...
								<div className='mt-4'>
									...
									<Input
										...
										className={`bg-gray-700/50 border-gray-600 text-white ${
											errors.tenthSubjects ? "border-red-500" : ""
										}`}
										aria-invalid={errors.tenthSubjects ? "true" : "false"}
									/>
									{errors.tenthSubjects && (
										<p className='text-red-500 text-sm mt-1'>
											{errors.tenthSubjects.message}
										</p>
									)}
								</div>
								...
								<div className='mt-4'>
									...
									<Input
										...
										{...register("tenthBoard")}
										className={`bg-gray-700/50 border-gray-600 text-white ${
											errors.tenthBoard ? "border-red-500" : ""
										}`}
							...
							<div className='bg-gray-800/30 p-6 rounded-lg border border-gray-700 mb-6'>
								...
								<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
									<div>
										...
										<Input
											...
											className={`bg-gray-700/50 border-gray-600 text-white ${
												errors.twelfthScore ? "border-red-500" : ""
											}`}
											aria-invalid={errors.twelfthScore ? "true" : "false"}
										/>
										{errors.twelfthScore && (
											<p className='text-red-500 text-sm mt-1'>
												{errors.twelfthScore.message}
											</p>
										)}
									</div>
									...
									<div>
										...
										<Input
											...
											className={`bg-gray-700/50 border-gray-600 text-white ${
												errors.twelfthYear ? "border-red-500" : ""
											}`}
								...
								<div className='mt-4'>
									...
									<Input
										...
										className={`bg-gray-700/50 border-gray-600 text-white ${
											errors.twelfthSubjects ? "border-red-500" : ""
										}`}
								...
								<div className='mt-4'>
									...
									<Input
										...
										className={`bg-gray-700/50 border-gray-600 text-white ${
											errors.twelfthBoard ? "border-red-500" : ""
										}`}
										...
										<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
											...
											<div>
												...
												<Input
													...
													aria-invalid={
														errors.graduationYear ? "true" : "false"
													}
												/>
										...
										<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
											...
											<div>
												...
												<Input
													...
													{...register("pgYear")}
													className={`bg-gray-700/50 border-gray-600 text-white ${
														errors.pgYear ? "border-red-500" : ""
													}`}
													aria-invalid={errors.pgYear ? "true" : "false"}
												/>
												{errors.pgYear && (
													<p className='text-red-500 text-sm mt-1'>
														{errors.pgYear.message}
													</p>
												)}
											</div>
										</div>
						...
						<div className='space-y-6'>
							<div className='bg-gray-800/30 p-6 rounded-lg border border-gray-700 mb-6'>
								...
								<p className='text-gray-300 mb-4'>
									Select the program type and specific course you wish to apply
									for. You can select up to three preferences.
								</p>
								...
								<div className='space-y-6'>
										...
										<Controller
											...
											render={({ field }) => (
												...
												>
													<SelectTrigger
														className={`bg-gray-700/50 border-gray-600 text-white ${
															errors.programType ? "border-red-500" : ""
														}`}
													...
													<SelectContent className='bg-gray-800 border-gray-700'>
														<SelectItem value='Skill Courses'>
															Skill Courses
														</SelectItem>
														<SelectItem value='Diploma'>Diploma</SelectItem>
														<SelectItem value='Undergraduate Degree'>
															Undergraduate Degree
														</SelectItem>
														<SelectItem value='Postgraduate Degree'>
															Postgraduate Degree
														</SelectItem>
														<SelectItem value='Doctoral Program'>
															Doctoral Program
														</SelectItem>
													</SelectContent>
												</Select>
									...
									<div>
										...
										<Input
											...
											className={`bg-gray-700/50 border-gray-600 text-white ${
												errors.firstPreference ? "border-red-500" : ""
											}`}
							...
							<div className='bg-gray-800/30 p-6 rounded-lg border border-gray-700'>
								...
								<p className='text-gray-300 mb-6'>
									Please upload the following documents in PDF or JPG format.
								...
								<div className='space-y-6'>
									<div>
										...
										{uploadedFiles.idCard && (
											<p className='text-green-400 text-sm mt-2'>
												Selected: {uploadedFiles.idCard.name}
											</p>
										)}
									</div>
										...
										<div className='flex items-center justify-center w-full'>
											<label className='flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer bg-gray-700/30 border-gray-600 hover:bg-gray-700/50'>
												...
												<input
													...
													accept='.pdf,.jpg,.jpeg,.png'
													onChange={(e) =>
														handleFileChange(e, "tenthCertificate")
													}
												/>
											</label>
										</div>
										{uploadedFiles.tenthCertificate && (
											<p className='text-green-400 text-sm mt-2'>
												Selected: {uploadedFiles.tenthCertificate.name}
											</p>
										)}
									</div>
										...
										<div className='flex items-center justify-center w-full'>
											<label className='flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer bg-gray-700/30 border-gray-600 hover:bg-gray-700/50'>
												...
												<input
													...
													accept='.pdf,.jpg,.jpeg,.png'
													onChange={(e) =>
														handleFileChange(e, "twelfthCertificate")
													}
												/>
											</label>
										</div>
										{uploadedFiles.twelfthCertificate && (
											<p className='text-green-400 text-sm mt-2'>
												Selected: {uploadedFiles.twelfthCertificate.name}
											</p>
										)}
									</div>
										...
										<div className='flex items-center justify-center w-full'>
											<label className='flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer bg-gray-700/30 border-gray-600 hover:bg-gray-700/50'>
												...
												<input
													...
													accept='.pdf,.jpg,.jpeg,.png'
													onChange={(e) =>
														handleFileChange(e, "graduationCertificate")
													}
												/>
											</label>
										</div>
										{uploadedFiles.graduationCertificate && (
											<p className='text-green-400 text-sm mt-2'>
												Selected: {uploadedFiles.graduationCertificate.name}
											</p>
										)}
									</div>
									...
									<div className='p-4 bg-brand-orange/10 rounded-lg border border-brand-orange/30'>
										<p className='text-gray-200 text-sm'>
											Note: All documents must be clear and legible. Incomplete
											or unclear documents may delay your application process.
										</p>
									</div>
								</div>
							</div>
							...
							<div className='bg-gray-800/30 p-6 rounded-lg border border-gray-700'>
								...
								<div className='mb-6'>
									...
									<div className='bg-gray-700/30 p-4 rounded-lg mb-4 text-gray-300 text-sm'>
										<ol className='list-decimal pl-5 space-y-2'>
											...
											<li>
												...
												in the cancellation of my admission and scholarship.
											</li>
											<li>
												I agree to abide by the rules and regulations of the
												institution where I will be studying.
											</li>
											<li>
												I will maintain regular attendance and satisfactory
												academic performance.
											</li>
											<li>
												I will not engage in any activity that may bring
												disrepute to the scholarship program or the institution.
											</li>
											<li>
												I understand that the scholarship may be withdrawn if I
												fail to meet the academic requirements or violate any
												rules.
											</li>
											<li>
												I will inform the scholarship authorities of any changes
												in my personal or academic status.
											</li>
											<li>
												I will participate in all mandatory activities organized
												by the scholarship program.
											</li>
											<li>
												I will represent my country with dignity and respect
											...
											render={({ field }) => (
												<Checkbox
													...
													className={`mt-1 data-[state=checked]:bg-brand-orange data-[state=checked]:border-brand-orange ${
														errors.studentDeclaration ? "border-red-500" : ""
													}`}
													aria-invalid={
														errors.studentDeclaration ? "true" : "false"
													}
												/>
											)}
										/>
									...
									{errors.studentDeclaration && (
										<p className='text-red-500 text-sm mt-1'>
											{errors.studentDeclaration.message}
										</p>
									)}
								</div>
								...
								<div>
									...
									<div className='bg-gray-700/30 p-4 rounded-lg mb-4 text-gray-300 text-sm'>
										<ol className='list-decimal pl-5 space-y-2'>
											<li>
												I hereby declare that I am aware of my ward's
												application for the Indo-African Scholarship program.
											</li>
											<li>
											...
											<li>
												I will support my ward in fulfilling all the
										...
										<Controller
											...
											render={({ field }) => (
												<Checkbox
													...
													onCheckedChange={field.onChange}
													className={`mt-1 data-[state=checked]:bg-brand-orange data-[state=checked]:border-brand-orange ${
														errors.parentDeclaration ? "border-red-500" : ""
													}`}
													aria-invalid={
														errors.parentDeclaration ? "true" : "false"
													}
												/>
											)}
										/>
									...
									{errors.parentDeclaration && (
										<p className='text-red-500 text-sm mt-1'>
											{errors.parentDeclaration.message}
										</p>
									)}
								</div>
							</div>
						...
						<div className='flex items-center justify-between max-w-4xl mx-auto'>
							<div
								className={`flex flex-col items-center ${
									step >= 1 ? "text-brand-orange" : "text-gray-500"
								}`}
							>
								<div
							...
							<div
								className={`w-16 md:w-24 h-1 ${
									step >= 2 ? "bg-brand-orange" : "bg-gray-700"
								}`}
							></div>

							<div
								className={`flex flex-col items-center ${
									step >= 2 ? "text-brand-orange" : "text-gray-500"
								}`}
							>
								<div
									className={`w-10 h-10 rounded-full flex items-center justify-center font-bold mb-2 ${
							...
							<div
								className={`w-16 md:w-24 h-1 ${
									step >= 3 ? "bg-brand-orange" : "bg-gray-700"
								}`}
							></div>

							<div
								className={`flex flex-col items-center ${
									step >= 3 ? "text-brand-orange" : "text-gray-500"
								}`}
							>
								<div
									className={`w-10 h-10 rounded-full flex items-center justify-center font-bold mb-2 ${
							...
							<div
								className={`w-16 md:w-24 h-1 ${
									step >= 4 ? "bg-brand-orange" : "bg-gray-700"
								}`}
							></div>

							<div
								className={`flex flex-col items-center ${
									step >= 4 ? "text-brand-orange" : "text-gray-500"
								}`}
							>
								<div
									className={`w-10 h-10 rounded-full flex items-center justify-center font-bold mb-2 ${
